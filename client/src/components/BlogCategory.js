...
function BlogCategory() {
  ...
  const { allData, loading } = useFetchData(`/category/${category}`);
        ...
        <div className="container">
          <div className="category_title">
              ...
              <h1>
                ...
                <span>
                  {loading ? (
                    ...
                    publishedBlogs?.filter((blog) => blog.category).length
                  )}
                </span>
              </h1>
            </div>
            <p>
              ...
              Consequuntur repellendus vel pariatur porro quibusdam laudantium
              reiciendis culpa. Vel modi nemo dolorem qui, voluptate quos non
              voluptas assumenda sint pariatur voluptates?
            </p>
          </div>
                  ...
                  return (
                    <div className="cate_blog" key={blog.slug}>
                      ...
                      <div className="bloginfo cmt-2">
                        ...
                        <Link to={`/blog/${blog.slug}`} className="cursor">
